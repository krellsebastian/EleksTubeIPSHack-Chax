...
// Preferences is an ESP32 utility. It saves data permanently on the ESP32 flash memory using the 
// Preferences.h library. The data held in the flash memory persists across resets or power failures. 
